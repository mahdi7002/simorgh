...
The public repository currently contains a runnable Python service, a dependency-free minimal demo, 12 personas, shared request orchestration, provenance-aware memory, a deterministic reviewer gate, and governed self-improvement policy paths.
